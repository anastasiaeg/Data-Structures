...
/**
 * Test for ArrayBasedList
 * @author Sarah Heckman & Anastasia Egorova
 *
 */
public class KindaArrayListTest {
	
	private KindaArrayList<String> list;
	...
	public void setUp() throws Exception {
		list = new KindaArrayList<String>();
	}
	...
	public void testIntegerArrayBasedList() {
		KindaArrayList<Integer> list2 = new KindaArrayList<Integer>();
		assertTrue(list2.isEmpty());
		assertEquals(0, list2.size());
		
		//Add 5 valid integers
		list2.add(1);
		list2.add(2);
		list2.add(3);
		list2.add(4);
		...
		assertEquals(2, (int)list2.get(1));
		assertEquals(3, (int)list2.get(2));
		assertEquals(4, (int)list2.get(3));
		assertEquals(5, (int)list2.get(4));
		
		//Remove the middle number
		assertEquals(3, (int)list2.remove(2));
		assertEquals(4, list2.size());
		assertEquals(1, (int)list2.get(0));
		assertEquals(2, (int)list2.get(1));
		assertEquals(4, (int)list2.get(2));
		assertEquals(5, (int)list2.get(3));
		...
		assertEquals(4, (int)list2.get(2));
		assertEquals(5, (int)list2.get(3));
		assertEquals(6, (int)list2.get(4));
		assertEquals(7, (int)list2.get(5));
		
		//Remove the first number
		assertEquals(1, (int)list2.remove(0));
		assertEquals(5, list2.size());
		assertEquals(2, (int)list2.get(0));
		assertEquals(4, (int)list2.get(1));
		assertEquals(5, (int)list2.get(2));
		assertEquals(6, (int)list2.get(3));
		assertEquals(7, (int)list2.get(4));
		...
		//Remove a last number
		assertEquals(7, (int)list2.remove(list2.size() - 1));
		assertEquals(5, list2.size());
		assertEquals(1, (int)list2.get(0));
		assertEquals(2, (int)list2.get(1));
		assertEquals(4, (int)list2.get(2));
		...
		assertEquals(2, (int)list2.remove(1));
		assertEquals(5, list2.size());
		assertEquals(1, (int)list2.get(0));
		assertEquals(4, (int)list2.get(1));
		assertEquals(5, (int)list2.get(2));
